        ...
        React.createElement("nav", null,
            React.createElement("ul", null,
                React.createElement("li", { className: "show_on_mobile flex_center" },
                    React.createElement("a", { className: "czs-menu-l", href: "#", style: { backgroundImage: `url("assets/czs-menu-l.svg")` }, onClick: (e) => {
                            e.preventDefault();
                            // @ts-ignore
                ...
                config.github && (React.createElement("li", { className: "flex_center" },
                    React.createElement("a", { className: "czs-github-logo", href: config.github, target: "_blank", style: { backgroundImage: `url("assets/czs-github-logo.svg")` } }))),
                React.createElement("li", { onClick: () => {
                    ...
                    React.createElement("span", { className: "czs-sun", style: { backgroundImage: `url("assets/czs-sun.svg")` } }),
                    React.createElement("span", { className: "czs-sun-l", style: { backgroundImage: `url("assets/czs-sun-l.svg")` } }),
                    React.createElement("span", { className: "czs-moon", style: { backgroundImage: `url("assets/czs-moon.svg")` } }),
                    React.createElement("span", { className: "czs-moon-l", style: { backgroundImage: `url("assets/czs-moon-l.svg")` } }))))));
};
