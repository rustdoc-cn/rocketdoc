...
const FoldableItem = ({ config, outputPath, sidebarItem: { text, link, children } }) => {
    ...
    const isActive = link === outputPath.replace(/index\.html$/, '');
    const foldOl = (fold) => {
    ...
    return (React.createElement("li", { className: children ? (fold ? 'fold' : 'unfold') : '' },
        React.createElement("a", { href: link ? `${link}` : '#', className: classnames('nav_link', {
                active: isActive,
                no_link: !link
            }), onClick: (e) => {
                if (link) {
            ...
            children && (React.createElement(React.Fragment, null,
                React.createElement("span", { className: "czs-angle-up-l", style: { backgroundImage: `url("assets/czs-angle-up-l.svg")` }, onClick: toggleFold }),
                React.createElement("span", { className: "czs-angle-down-l", style: { backgroundImage: `url("assets/czs-angle-down-l.svg")` }, onClick: toggleFold })))),
